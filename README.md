...
# Wallox Theme Integration

This Laravel Starter project has been integrated with the **Wallox HTML theme**. The theme files have been converted to Blade templates and are available in the frontend views.

## Wallox Theme Routes

The Wallox theme pages are accessible at the following URLs:

- **Home**: `/wallox` - Main homepage
- **About**: `/wallox/about` - About page  
- **Services**: `/wallox/services` - Services overview
- **Gallery**: `/wallox/gallery` - Image gallery
- **Team**: `/wallox/team` - Team members
- **Blog**: `/wallox/blog` - Blog grid layout
- **Products**: `/wallox/products` - Products catalog
- **Cart**: `/wallox/cart` - Shopping cart
- **Checkout**: `/wallox/checkout` - Checkout process
- **Contact**: `/wallox/contact` - Contact form
- **FAQ**: `/wallox/faq` - Frequently asked questions
- **Testimonials**: `/wallox/testimonials` - Customer testimonials

## Theme File Structure

- **Views**: `resources/views/frontend/` - Blade template files
- **Assets**: `public/assets/` - CSS, JS, images, and other static files
- **Routes**: Defined in `routes/web.php` under the frontend group

## Quick Start

1. Run `php artisan serve` to start the development server
2. Visit `http://127.0.0.1:8000/wallox` to see the Wallox homepage
3. Navigate through the different theme pages using the URLs above
